...
rm $1.nodes
rm $1.sim
lctime_tholin --liberty template.lib --include "/foss/pdks/gf180mcuD/libs.tech/ngspice/design.ngspice" --library "/foss/pdks/gf180mcuD/libs.tech/ngspice/sm141064.ngspice $4" --output-loads "$2" --slew-times "$3" --spice $1.spice --cell $1 --output ./test.lib
rm $1.spice
